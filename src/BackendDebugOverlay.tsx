...
import {
  type BackendDebugOptions,
  getBackendDebugOptions,
  setBackendDebugOptions,
} from "../backend.js";

const INFINITE_SLIDER_VALUE = 61;

export default function BackendDebugOverlay() {
  const [value, setValue] = useState(getBackendDebugOptions);

  function update(nextValue: BackendDebugOptions) {
    setBackendDebugOptions(nextValue);
    setValue(nextValue);
  }
